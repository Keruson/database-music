<?php
    ...
    $sqlTotal = "SELECT COUNT(*) as Total FROM tbdisco WHERE IsDeleted = 0";
    ...
    {
        $codDisco = (int)$_POST['codDisco'];

        $comando = "UPDATE tbdisco
                    SET IsDeleted = 1
...
<head>
    ...
    <style>
        ...
        gap: 15px;      /* Adiciona um espaçamento de 15px entre os botões */
    }
    </style>
</head>
...
<?php
        ...
        if($busca != "")
        {
            $comando .= " AND d.Titulo LIKE '%$busca%'";
            $comando .= " OR d.Genero LIKE '%$busca%'";
            $comando .= " OR a.Nome LIKE '%$busca%'";
            $comando .= " OR d.Gravadora LIKE '%$busca%'";
        }

        $comando .= " GROUP BY d.CodDisco LIMIT $registrosPorPagina OFFSET $offset";
    ...
    else 
    {
        ...
        {
            echo "<p>Não Existem Discos no Banco de Dados</p>";
        }
        else
        {
            echo"
    ...
    <script>
        ...
        document.querySelectorAll('.btnExcluir').forEach(botao => {
            ...
            botao.addEventListener('click', function() {
                ...
                document.getElementById('codDisco').value = id;
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <p class="mb-4"> Deseja realmente excluir o disco <strong id="nomeDisco"></strong>?</p>
                    <div class="text-end">
                        <form method="POST">
                            <input type="hidden" name="codDisco" id="codDisco">
